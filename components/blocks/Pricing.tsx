...
const Pricing = async () => {
  ...
  return <section id="pricing" className="container py-24 sm:py-32">
      <h2 className="text-3xl md:text-4xl font-bold text-center">Unlock<span className="bg-gradient-to-b from-primary/60 to-primary text-transparent bg-clip-text">
          {" "}Premium{" "}
        </span>Research</h2>
      <h3 className="text-xl text-center text-muted-foreground pt-4 pb-8">Transform complex topics into professional reports in minutes, not hours!</h3>
        ...
        services
              ...
              <CardHeader>
                <CardTitle className="flex item-center justify-between">
                  {title}
                  {popular ? <span className="text-sm text-primary secondary">Most popular</span> : null}
                </CardTitle>
                <div>
